...
Step 9. Add OpenTelemetry instrumentation to the API, including Traces (Activities), Metrics and Logs. The instrumentation should be designed to provide insights into the performance and behavior of the API, and to help identify and troubleshoot issues.
