...
globs:
  - "RestReactAspire.Server/Models/**"
---

# Data Models and DTOs

## Domain Models
- Located in `RestReactAspire.Server/Models/`.
...
- Use `DateOnly` for dates and `TimeOnly` for times (with custom LiteDB serializers in `LiteDbFactory`).
