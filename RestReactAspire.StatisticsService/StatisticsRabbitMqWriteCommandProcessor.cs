...
public sealed class StatisticsRabbitMqWriteCommandProcessor : BackgroundService
{
    ...
    private readonly ILogger<StatisticsRabbitMqWriteCommandProcessor> _logger;

    public StatisticsRabbitMqWriteCommandProcessor(
        RabbitMqConnectionManager connectionManager,
        IOptions<RabbitMqOptions> options,
        StatisticsWriteCommandHandler handler,
