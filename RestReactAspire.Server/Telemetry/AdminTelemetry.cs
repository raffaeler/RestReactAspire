...
public static class AdminTelemetry
{
    ...
    public static readonly Counter<long> SeedExecuted = _meter.CreateCounter<long>(
        "hospital.admin.seed_executed", description: "Number of times seed data was executed");

    public static readonly Counter<long> ResetExecuted = _meter.CreateCounter<long>(
        "hospital.admin.reset_executed", description: "Number of times data reset was executed");

    public static readonly Counter<long> StatsQueried = _meter.CreateCounter<long>(
