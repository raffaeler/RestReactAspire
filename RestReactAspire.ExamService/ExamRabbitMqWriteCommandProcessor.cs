...
public sealed class ExamRabbitMqWriteCommandProcessor : BackgroundService
{
    ...
    private readonly ILogger<ExamRabbitMqWriteCommandProcessor> _logger;

    public ExamRabbitMqWriteCommandProcessor(
        RabbitMqConnectionManager connectionManager,
        IOptions<RabbitMqOptions> options,
        ExamWriteCommandHandler handler,
